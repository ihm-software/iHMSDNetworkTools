...
@{
    ...
    FunctionsToExport = @('Add-LogEntry','Add-LogError','Get-NetworkInformation','Invoke-SharepointUpload','Invoke-Speedtest','Send-NetworkInformation','Start-Log','Stop-Log')
